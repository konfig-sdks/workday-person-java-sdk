...
public class PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235 {
  ...
  public PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235() {
  }

  public PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235 instantMessengers(List<InstantMessengerAccount33e26848dc00100036f723337ebb0132> instantMessengers) {
  ...
  public PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235 addInstantMessengersItem(InstantMessengerAccount33e26848dc00100036f723337ebb0132 instantMessengersItem) {
  ...
  **/
  ...
  public PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235 phoneNumbers(List<PhoneReferenceDf014bc8b5fa10000af0fe7cb0ab00dd> phoneNumbers) {
  ...
  public PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235 addPhoneNumbersItem(PhoneReferenceDf014bc8b5fa10000af0fe7cb0ab00dd phoneNumbersItem) {
  ...
  **/
  ...
  public PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235 addresses(List<AddressReference9c3ab7b846e4100009e5ec55fa530024> addresses) {
  ...
  public PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235 addAddressesItem(AddressReference9c3ab7b846e4100009e5ec55fa530024 addressesItem) {
  ...
  **/
  ...
  public PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235 webAddresses(List<WebAddress33e26848dc0010003893a0202ced0165> webAddresses) {
  ...
  public PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235 addWebAddressesItem(WebAddress33e26848dc0010003893a0202ced0165 webAddressesItem) {
  ...
  **/
  ...
  public PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235 emails(List<EmailReference9c3ab7b846e41000327e788d9664012a> emails) {
  ...
  public PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235 addEmailsItem(EmailReference9c3ab7b846e41000327e788d9664012a emailsItem) {
    if (this.emails == null) {
  ...
  **/
   ...
   * @return the PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235 instance itself
   */
  public PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235 personPublicRepresentationD8f2aecf3d63100016a77ab413a20235 = (PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235) o;
    return Objects.equals(this.instantMessengers, personPublicRepresentationD8f2aecf3d63100016a77ab413a20235.instantMessengers) &&
        Objects.equals(this.phoneNumbers, personPublicRepresentationD8f2aecf3d63100016a77ab413a20235.phoneNumbers) &&
        Objects.equals(this.addresses, personPublicRepresentationD8f2aecf3d63100016a77ab413a20235.addresses) &&
        Objects.equals(this.webAddresses, personPublicRepresentationD8f2aecf3d63100016a77ab413a20235.webAddresses) &&
        Objects.equals(this.emails, personPublicRepresentationD8f2aecf3d63100016a77ab413a20235.emails)&&
        Objects.equals(this.additionalProperties, personPublicRepresentationD8f2aecf3d63100016a77ab413a20235.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235 is not found in the empty JSON string", PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235.class));

       return (TypeAdapter<T>) new TypeAdapter<PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235>() {
           @Override
           public void write(JsonWriter out, PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235 value) throws IOException {
           ...
           @Override
           public PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235
  * @throws IOException if the JSON string is invalid with respect to PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235
  */
  public static PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235.class);
  }

 /**
  * Convert an instance of PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235 to an JSON string
  *
  * @return JSON string
  */
