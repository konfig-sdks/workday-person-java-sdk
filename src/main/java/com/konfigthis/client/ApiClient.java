...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://<tenantHostname>/person/v4";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://<tenantHostname>/person/v4)
